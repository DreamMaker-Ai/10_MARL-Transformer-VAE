...
class MarlTransformerModel(tf.keras.models.Model):
    ...
    :return: Q logits (None,n,action_dim), n=max_num_agents
             ...
             z_stats [z_mu, z_logvar]=[(None,n,256),(None,n,256)]
    ...
    =================================================================
     ...
     cnn_model (CNNModel)        ((None, 15, 256),         665862
                                  (None, 15, 256),
                                  (None, 15, 256),
                                  (None, 15, 15, 15, 6))
    ...
    =================================================================
    Total params: 2,113,547
    Trainable params: 2,113,547
    ...
    def call(self, x, mask, training=True):
        ...
        """ CNN layer """
        z_mu, z_logvar, features_cnn, reconst = self.cnn(x, mask)  # (1,n,hidden_dim)
        ...
        return q_logits, [score1, score2], [z_mu, z_logvar], reconst
    ...
    def build_graph(self, mask):
        ...
        z_mu, z_logvar, features_cnn, reconst = self.cnn(x, mask)
        ...
        model = tf.keras.models.Model(
            inputs=[x],
            outputs=[q_logits, [score1, score2], [z_mu, z_logvar], reconst],
...
def main():
    ...
    q_logits, scores, z_stats, reconst_maps = marl_transformer(padded_obs, mask, training=True)
